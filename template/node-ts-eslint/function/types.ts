...
export type BinaryCallback = (err: any, message: any, isBinary: Boolean) => void
...
export interface IHandler {
  (event: IFunctionEvent, context: BinaryAcceptingFunctionContext, cb: any): any | Promise<any>;
}
